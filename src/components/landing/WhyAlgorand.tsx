  ...
  return (
    <section id="why-algorand" className="py-24 md:py-32 bg-[#060606]">
      <div className="px-5 md:px-8 lg:px-12 max-w-7xl mx-auto mb-16 md:mb-20">
        ...
        >
          <div>
            <p className="text-[#747878] text-[0.7rem] font-semibold uppercase tracking-[0.2em] mb-4">Why Algorand</p>
          ...
          <div className="flex items-center gap-2 bg-white/[0.04] border border-white/[0.08] rounded-full px-4 py-2 self-start md:self-auto">
            ...
            <span className="text-[#8e9191] text-[0.72rem] font-medium">Built on Algorand</span>
          </div>
        </motion.div>
      </div>
      ...
      <div className="px-5 md:px-8 lg:px-12 max-w-7xl mx-auto mt-12">
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="text-[#8e9191] text-sm">Universal Algo Kit executes cross-chain intents on Algorand, enabling multi-chain applications without deploying on every network.</div>
          </div>
          <a
            href="/docs"
